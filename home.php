...
<div class="all_container1">
  <div class="show">
    <div style="position:absolute;">  
     <div class="menu1"><a href="home.php"><img  style="position:absolute; left: 1530px; top: -13px;" src="img/home.png"  alt="Saisie"  /></a></div>
      <div class="menu1"><a href="factures.php"><img  style="position:absolute; left: 1560px; top: -19px;height:35px;" src="img/report.png"  alt="Saisie"  /></a></div>
...
<table>
 <tr>
   <td align="right"><strong>DATE</td><td></strong><input type="text" size="50"  value="<?php echo $date ?>" placeholder="" name="date" /></td>
   </tr>
    <tr>
   ...
   <tr>
   <td align="right"><strong>DATE OF BIRTH</td><td></strong>
   ...
   <tr>
   <td align="right"><strong>TELEPHONE</td></strong><td><input autocomplete="off" type="text" size="50" value="<?php echo $tel ?>" placeholder="" name="tel" /></td>
   </tr> 
   <tr>
   <td align="right"><strong>E-MAIL</td></strong><td><input autocomplete="off" type="email" size="50" value="<?php echo $Email ?>" placeholder="" name="email" /></td>
   </tr>   
    
   <tr>
   <td align="right"><strong>COUNTRY</td></strong><td><input autocomplete="off" type="text" size="50" value="<?php echo $country ?>" placeholder="" name="country" /></td>
   </tr>  
   <tr>
   <td align="right"><strong>CITY</td></strong><td><input autocomplete="off" type="text" size="50" value="<?php echo $city ?>" placeholder="" name="city" /></td>
   </tr> 
   <tr>
